...
<ul>
  ...
  <li class="form-row">
		<a href="<?php echo pageflow_url_for($flow,"doCancel", "@sf_guard_member_register") ?>">edit</a><br />
		<a href="<?php echo pageflow_url_for($flow,"doConfirm","@sf_guard_member_register") ?>">complete</a>
  </li>
</ul>
